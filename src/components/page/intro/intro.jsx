      ...
      <div className="w-full max-w-7xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden grid md:grid-cols-2 gap-0">
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          ...
          <div className="mt-12 text-center md:text-left">
            <Button onClick={onStart} className="px-10 py-4 text-xl font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transform hover:scale-105 transition duration-300">
